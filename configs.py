...
class Configs:
    ...
    CHANNEL_LINK = getenv("CHANNEL_LINK", "https://t.me/kakamusic045")
    GROUP_LINK = getenv("GROUP_LINK", "https://t.me/marrkmusic")
    UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/malek045/KAKAVCPlayer")
